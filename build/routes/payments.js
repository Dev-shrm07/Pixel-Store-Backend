...
const PaymentController = __importStar(require("../controllers/payments"));
const body_parser_1 = __importDefault(require("body-parser"));
const router = (0, express_1.Router)();
router.post('/register', PaymentController.RegisterUser);
router.post('/webhook', body_parser_1.default.raw({ type: 'application/json' }), PaymentController.HandlWebhooks);
